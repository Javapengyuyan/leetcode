...
public class FactoryDemo {
    public static void main(String[] args) {
        ...
        try {
            ...
            //Class<?> aClass = Class.forName("com.designPatterns.creativeModel.factory.abstractFactory.IFactory");
            Class<IFactory> aClass = (Class<IFactory>) Class.forName("com.designPatterns.creativeModel.factory.abstractFactory.IFactory");
            ...
            Method method = aClass.getMethod("com.designPatterns.creativeModel.factory.abstractFactory.IFactory.createFruit");
